...
int** ZombieLevelManager::nextLevel(VertexArray& rVaLevel)
{
	m_LevelSize.x = 0;
	m_LevelSize.y = 0;
...
Vector2i ZombieLevelManager::getLevelSize()
{
	return m_LevelSize;
}

int ZombieLevelManager::getCurrentLevel()
{
	return m_CurrentLevel;
}

float ZombieLevelManager::getTimeLimit()
{
	return m_BaseTimeLimit * m_TimeModifier;
}

Vector2f ZombieLevelManager::getStartPosition()
{
