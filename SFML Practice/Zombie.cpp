...
Zombie::Zombie() : m_Sprite(Sprite(TextureHolder::GetTexture("graphics/blood.png")))
{
}
...
void Zombie::update(float elapsedTime, Vector2f playerLocation)
{
	...
	// This calculation finds the angle that's needed to face the zombie toward the player
