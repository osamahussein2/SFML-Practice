...
//
//	Sprite branches[NUM_BRANCHES] = { Sprite(textureBranch), Sprite(textureBranch), Sprite(textureBranch),
...
//			timeRemaining = 6;
//
//			// Make all the branches disappear - starting in the second pos
...
//				FloatRect textRect = messageText.getLocalBounds();
//
//				messageText.setOrigin(Vector2f(textRect.position.x + textRect.size.x / 2.0f,
